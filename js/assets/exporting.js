        ...
        r(A.prototype, {
            sanitizeSVG: function(a, c) {
                if (c && c.exporting && c.exporting.allowHTML) {
                    var e = a.match(/<\/svg>(.*?$)/);
                    e && (e = '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"' + c.chart.width + '" height\x3d"' + c.chart.height + '"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' + e[1] + "\x3c/body\x3e\x3c/foreignObject\x3e",
            ...
            addButton: function(a) {
                ...
                c.exportDivElements || (c.exportDivElements = [],
                c.exportSVGElements = []);
                if (!1 !== b.enabled) {
            ...
            destroyExport: function(a) {
                ...
                a && (k(a, function(a, e) {
                    ...
                    c.exportSVGElements[e] = a.destroy())
                }),
                a.length = 0);
                e && (k(e, function(a, e) {
